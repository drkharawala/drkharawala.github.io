...
export const SITE_DATA = {
    ...
    name: 'Amrin Kharawala, MD',

    // A brief tagline describing your role or expertise (3-5 words/phrases)
    tagline: "Cardiovascular Medicine Fellow | FIT Representative, ACC Nebraska Chapter",
    ...
    scholar: "HCliY98AAAAJ",

    // Your email address (use [at] and [dot] to avoid spam bots)
    email: "amrin.kharawala@outlook.com",

    // One-line research tagline used for SEO and social sharing meta tags
    description: "Cardiovascular medicine fellow and clinician-researcher focused on preventive cardiology, cardiovascular imaging, women's heart health, and health equity.",
